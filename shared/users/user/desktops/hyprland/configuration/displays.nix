...
let
	...
	displays = osConfig."${szy}".desktops.options.displays.displays;
...
in
{
	...
	wayland.windowManager.hyprland.settings = {
		...
		let
			...
			mirror = if (display.mirror == null) then "" else ", mirror, ${osConfig."${szy}".desktops.options.displays.displays."${display.mirror}".hardware.portName}";
		in
