...
let
  ...
  resolvedDefault = szy.utils.mergeAll [
    osConfig."${szy}".desktops.components.variables.default
    config."${szy}".desktops.components.variables.default
  ];
  resolvedHyprland = szy.utils.mergeAll [
    (osConfig."${szy}".desktops.components.variables.variables.hyprland or { })
    (config."${szy}".desktops.components.variables.variables.hyprland or { })
  ];
in
{
