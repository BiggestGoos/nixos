...
rec {
      ...
      f =
        ...
        if builtins.isAttrs a && builtins.isAttrs b then
          ...
          if (overlaps != { }) then
            ...
            builtins.mapAttrs (k: v: if b ? ${k} then f v b.${k} else v) a
            // builtins.removeAttrs b (builtins.attrNames a)
        else
          b;
    in
    builtins.foldl' f { } sets;
  ...
  options = {
    ...
    getFromKeys =
      ...
      lib.attrsets.attrByPath keys default object;
