  ...
  declare =
    ...
    in
    {
        ...
        (utils.options.createFromKeys {
          ...
          value = {
            ...
            meta = {
              ...
              identifier = utils.options.constant {
                type = lib.types.str;
              ...
              */
              ...
              template = {
                ...
                arguments = utils.options.constant {
                  type = lib.types.either (lib.types.attrs) (lib.types.functionTo lib.types.attrs);
              ...
              */
              ...
              definitions =
                let
                  identifiers = lib.attrsets.mapAttrsToList (
                    name: value: value.meta.identifier
                ...
                definitions = utils.options.constant {
                  ...
                  value =
                    let
                      ...
                      allDefinitions = lib.lists.flatten (
                        lib.attrsets.mapAttrsToList (
                          name: value: (lib.attrsets.mapAttrsToList (name: value: value) (value.definitions or { }))
                        ) allTemplates
                      );
                      ...
                      definitions =
                        builtins.map
                          ...
                          (
                            builtins.filter (
                              definition: builtins.elem global.final.meta.identifier definition.meta.full.extends
                            ) allDefinitions
                          );
                  ...
                  builtinParameters = {
                    ...
                    enabled =
                      let
                        ...
                        allExtendsEnabled = lib.lists.all (
                          identifier:
                          (helper.template.get {
                            inherit (input) config;
                            inherit identifier;
                  ...
                  parameters =
                    builtins.map
                      ...
                      (
                        ...
                        ++ (builtins.map (template: template.meta.template.parameters) allTemplates)
                      );

                  arguments = builtins.map (arguments: global.resolveSet arguments) (
                    builtins.map (template: template.meta.template.arguments) allTemplates
                  );
      ...
      */
      imports =
        let
          anyDefinitionEnabled = lib.lists.any (definition: definition.data.enabled) (
            builtins.map (
              identifier:
              helper.definition.get {
                inherit (input) config;
                inherit identifier;
              }
