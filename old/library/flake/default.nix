{ self, lib }:
{
	...
	in
	{
		...
		lib.nixosSystem 
		{
			...
			modules = 
			[ 
				szy.import.modules.path szy.import.modules.system szy.import.modules.shared 
			] ++ 
			[
				...
				self.inputs.home-manager.nixosModules.home-manager
				{
					home-manager = 
					{
						...
						sharedModules = 
						[ 
							szy.import.modules.users.user.path szy.import.modules.user szy.import.modules.shared 
						];
					};
				}
			] ++ [ {
