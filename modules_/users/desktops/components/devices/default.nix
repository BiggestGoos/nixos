        ...
        accelerationGenerator =
          ...
          lib.mkOption {
            type =
              ...
              in
              lib.types.nullOr (
                lib.types.either (lib.types.enum values) (lib.types.submoduleWith { modules = [ template ]; })
              );
            default = null;
          };
                  ...
                  extraTemplate.options = {
                    ...
                    scrolling.method = lib.mkOption {
                      type =
                        ...
                        in
                        lib.types.nullOr (
                          lib.types.either (lib.types.enum [ "none" ]) (lib.types.submoduleWith { modules = [ template ]; })
                        );
                      default = null;
                ...
                type =
                  ...
                  lib.types.nullOr (
                    lib.types.either (lib.types.enum [
                      ...
                      "edge"
                      "none"
                    ]) (lib.types.submoduleWith { modules = [ template ]; })
                  );
                default = null;
                description = "If a set then scroll-button method will be used";
              };
